...
function initApp() {
    console.log("Synexus Core ES6 Modular Architecture Initialized (Day 37 Parallel Architecture Active).");
    initThemeToggle();
    initMobileMenu();
    ...
    initTaskTracker(); 
    initGitHubLookup();
    initDashboardView(); // Day 37 addition
    initMentorModal();
    initFormValidation();
