document.addEventListener('DOMContentLoaded', () => {
    ...
    /* ========================================== */
    /* 1. DAY 22: INTERSECTION OBSERVER API      */
    /* ========================================== */

    // Create the IntersectionObserver instance
    const scrollObserver = new IntersectionObserver((entries) => {
        entries.forEach((entry) => {
            // Check if element crossed into the viewport
            if (entry.isIntersecting) {
                // Add the .show class to trigger CSS transition
                entry.target.classList.add('show');

                // Optional: Stop observing once animated to optimize memory
    ...
    // Function to observe all elements with .hidden class
    ...
    /* ========================================== */
    /* 2. DAY 21: DEBOUNCE UTILITY (CLOSURE)      */
    /* ========================================== */
    ...
    /* ========================================== */
    /* 3. ACTIVE INITIATIVES & DEBOUNCED SEARCH   */
    /* ========================================== */
    ...
    function renderInitiatives(items) {
        ...
        items.forEach(item => {
            ...
            // Attach hidden class for observer scroll animation
    ...
    /* ========================================== */
    /* 5. STATEFUL ROADMAP TASK TRACKER           */
    /* ========================================== */
    ...
    // Initial load for task tracker & static observer targets
