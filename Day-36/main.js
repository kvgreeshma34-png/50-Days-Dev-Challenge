...
function initGitHubLookup() {
    ...
    // Helper function to update the URL parameters without reloading the page
    ...
    // Hydrate state from URL on initial page load
...
function initApp() {
    console.log("Synexus Core ES6 Modular Architecture Initialized (Day 36 Deep Linking Active).");
    initThemeToggle();
    initMobileMenu();
